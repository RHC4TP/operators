...
The operator certification tooling is still under development. It is expected to be available in December 2018. At that time, once the operator has passed the certification scan, it can be published alongside the container image in the Red Hat Container Catalog (RHCC).
