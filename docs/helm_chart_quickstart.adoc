...
We continue by creating the metadata or descriptive data file for the chart itself. Create a file named `Chart.yaml` in an editor, with the following contents:
